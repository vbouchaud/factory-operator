...
//+kubebuilder:rbac:groups=app.heidrun.bouchaud.org,resources=bindings,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=app.heidrun.bouchaud.org,resources=bindings/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=app.heidrun.bouchaud.org,resources=bindings/finalizers,verbs=update
